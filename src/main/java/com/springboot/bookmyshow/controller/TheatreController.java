...
public class TheatreController 
{
	...
	@GetMapping
	public ResponseEntity<ResponseStructure<Theatre>> findTheatreAdmin(@RequestParam int theatreId)
	{
	...
	@PutMapping
	public ResponseEntity<ResponseStructure<Theatre>> updateBooking(@RequestBody Theatre theatre,@RequestParam int theatreId)
	{
